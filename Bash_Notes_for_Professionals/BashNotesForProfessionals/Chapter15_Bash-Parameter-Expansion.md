...
## 15.2: Length of parameter(Độ dài của một tham số)
...
## 15.5: Delete a pattern from the beginning of a string(Xóa một mẫu khỏi đầu 1 chuỗi)
* ký tự đầ tiên
```
...
## 15.10: Munging during expansion()
